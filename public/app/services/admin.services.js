angular.module('admin.service', [])
    ...
    .factory('sidiServices', sidiServices)
    .factory('nikahServices', nikahServices)
    ;
    ...
    function put(param) {
        ...
        $http({
            ...
            (res) => {
                ...
                if (data) {
                    data.nama_jenis = param.nama_jenis;
                    data.status_jenis = param.status_jenis;
                }
                def.resolve(res.data);
            },
            (err) => {
...
function sidiServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'sidi/';
    var service = {};
    service.data = [];
    return {
        get: get,
...
function nikahServices($http, $q, helperServices, AuthService, pesan) {
    var controller = helperServices.url + 'nikah/';
    var service = {};
    service.data = [];
    return {
        get: get,
